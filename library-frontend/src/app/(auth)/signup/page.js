...
const signup = () => {
  return (
    <section className="min-h-screen p-4 md:p-6 flex flex-col md:flex-row items-center justify-between">
      ...
      <div className="w-full md:w-1/2 lg:w-[40%] bg-white rounded-3xl md:rounded-4xl p-6 md:p-10 lg:p-16 flex items-start justify-center mt-6 md:mt-0">
        <Suspense fallback={<div className="w-full p-4">Loading signup form...</div>}>
          <SignupForm />
        </Suspense>
      </div>
    </section>
